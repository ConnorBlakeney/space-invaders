...
class Game:
    def __init__(self):
        ...
        self.obstacle_x_positions = [num * (screen_height / self.obstacle_amount) for num in range(self.obstacle_amount)]
    ...
    def display_lives(self):
        for life in range(self.lives - 1):
            x = self.live_x_start_pos + (life * (self.live_surface.get_size()[0] + 10))
